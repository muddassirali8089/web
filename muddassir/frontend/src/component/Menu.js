...
<div id="nav2">
        ...
        {
             Menuiteminfo.filter((ref)=>ref.catogory==="Pizza").map((piza , index) => (
    ...
    <div className="card" id = "cards">
      <div className="card-body">
       ...
       <p> Price : {piza.price} </p>
        ...
        {
             Menuiteminfo.filter((ref)=>ref. catogory==="Burger").map((piza , index) => (
   ...
   <div className="card" id = "cards">
      <div className="card-body">
       ...
       <p> Price : {piza.price} </p>
        ...
        {
              Menuiteminfo.filter((ref)=>ref. catogory==="MilkShake").map((piza, index) => (
